...
import { ChevronLeft, Check, AlertCircle, Building, CreditCard, Hash, Ticket, FileText, Scale, Coins } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans selection:bg-[#50C2C9] selection:text-white">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-md mx-auto px-4 py-4 flex items-center">
          ...
          <h1 className="text-xl font-bold text-gray-900 ml-2">Offline Payment QB</h1>
        </div>
      </div>
        ...
        {success ? (
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100 relative overflow-hidden">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">Review details and complete payment</p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="font-mono text-sm font-semibold text-gray-900 truncate">{transactionId || "N/A"}</p>
              </div>
              ...
              <div className="border-t border-gray-100 pt-4 pb-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-blue-50/50 rounded-xl border border-blue-100">
                    ...
                    <p className="font-semibold text-gray-900 text-sm truncate">{metalName || metalType || "N/A"}</p>
                  </div>
                  <div className="p-3 bg-blue-50/50 rounded-xl border border-blue-100">
                    <div className="flex items-center space-x-2 mb-1">
                      <Scale className="w-4 h-4 text-blue-500" />
                      <span className="text-xs font-medium text-gray-500">Wait</span>
                    </div>
                    <p className="font-semibold text-gray-900 text-sm">{grams ? `${grams}g` : "N/A"}</p>
                  </div>
                </div>
              </div>
